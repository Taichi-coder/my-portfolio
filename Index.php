...
$sql1 = "SELECT * FROM contact_form WHERE id = 1";
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO contact_form (firstname, lastname, email, subject) VALUES ('$firstname', '$lastname', '$email', '$messages')";
...
<head>
    ...
    <script src="mainportfolio.js" defer></script>
...
<body>
    <header>
        <div class="first">
            <a href="#portfolio">
                <p class="p1">Chima Chibuike</p>
                <p class="p2">Concepts</p>
            </a>
        </div>
        <div class="second">
            ...
            <form action="index.php" method="post">
                <div>
                    ...
                    <div class="col-8 mb-4">
                        ...
                        <input type="email" class="form-control" placeholder="Insert email" aria-label="email" id="email" name="email" require>
                    </div>
                    <div class="form-floating col-10">
                        <textarea class="form-control" placeholder="Leave a comment here" id="messages" name="messages" style="height: 250px" required></textarea>
                        <label for="messages" class=" fs-6 fw-bold">Subject: *</label>
                      </div>
                  </div>
